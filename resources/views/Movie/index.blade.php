...
@section('contentMain')
	...
	<section class="home">
		...
		<div class="owl-carousel home__bg">
			<div class="item home__cover" data-bg="{{ asset('storage/images/home/home__bg.jpg') }}"></div>
			<div class="item home__cover" data-bg="{{ asset('storage/images/home/home__bg2.jpg') }}"></div>
			<div class="item home__cover" data-bg="{{ asset('storage/images/home/home__bg3.jpg') }}"></div>
			<div class="item home__cover" data-bg="{{ asset('storage/images/home/home__bg4.jpg') }}"></div>
		</div>
		<!-- end home bg -->
						...
						<div class="item">
							...
							<div class="card card--big">
								<div class="card__cover">
									<img src="{{ asset('storage/images/home/home__bg.jpg') }}" alt="">
