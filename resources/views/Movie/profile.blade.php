...
@section('contentMain')
    <!-- page title -->
	<section class="section section--first section--bg" data-bg="{{ asset('storage/images/section.jpg') }}">
		<div class="container">
			<div class="row">
				<div class="col-12">
						...
						<div class="profile__content">
							<div class="profile__user">
								...
								<div class="profile__meta">
									...
									<span>Phoenix ID: {{ Auth::user()->id }}</span>
								</div>
							</div>
				...
				<div class="tab-pane fade show active" id="tab-1" role="tabpanel" aria-labelledby="1-tab">
					<div class="row">
						...
						<div class="col-12 col-lg-6">
							<form method="POST" action="{{ route('user.update') }}" class="profile__form">
                                @csrf
                                @method('PUT')
								...
								<div class="row">
									...
									<div class="col-12 col-md-6 col-lg-12 col-xl-6">
										<div class="profile__group">
											...
											<input id="username" type="text" name="username" class="profile__input" placeholder="User 123" value="{{ Auth::user()->name }}">
										</div>
									</div>
									...
									<div class="col-12 col-md-6 col-lg-12 col-xl-6">
										<div class="profile__group">
											...
											<input id="email" type="text" name="email" class="profile__input" placeholder="email@email.com" value="{{ Auth::user()->email }}">
										</div>
									</div>

                                    <div class="col-12 col-md-6 col-lg-12 col-xl-6 d-none">
										<div class="profile__group">
											<label class="profile__label" for="email">id</label>
											<input id="id" type="number" name="id" class="profile__input" placeholder="id" value="{{ Auth::user()->id }}">
										</div>
									</div>
